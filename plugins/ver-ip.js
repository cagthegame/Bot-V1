...
🔖 Solicitado por : @${n.replace(/@.+/,"")}`,footer:`${NombreDelBot} 🔥`,location:{degreesLatitude:r.latitud,degreesLongitude:r.longitud},buttons:[{buttonId:"</bromita>",buttonText:{displayText:`[ INFORMACI\xd3N ]
\`\`\`
